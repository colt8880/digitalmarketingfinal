...
def load_api():
    ...
    consumer_key = 'fIgLkoNTc9ePVRQIStJTaQyPR'
    consumer_secret = 'Tda8FpjT3Iv31dsI7j9HHRlK1OquWKYQ77lg1Yl7iiKkRo5my7'
    access_token = '1512044598-fI24C7MLNIMz2y5xWizw4RZ2ujy4FTqK1k9r0tj'
    access_secret = 'OHgc0kTj140HKg1RocUQvs6tkokHWxVQoUx5bz1R69sbB'
...
def main():
    ''' This is a script that continuously searches for tweets
        that werxe created over a given number of days. The search
        dates and search phrase can be changed below. '''



    ''' search variables: '''
    search_phrases = ['healthtech','digitalhealth','DigitalHealth']
